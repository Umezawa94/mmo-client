...
export default class Game {
    ...
    createScene() {
        ...
        let sphere = BABYLON.MeshBuilder.CreateSphere('sphere1', { segments: 16, diameter: 200 }, scene);
        ...
        //     // mesh.receiveShadows = true;
        // });
        let plane = BABYLON.MeshBuilder.CreateGround('ground1', { width: 100, height: 100, subdivisions: 2 }, this._scene);
