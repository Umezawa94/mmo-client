...
export class LensFlareSystem extends BABYLON.LensFlareSystem {
    ...
    render() {
        ...
        var awayX;
        var awayY;
        let positionX = this._positionX;
        let positionY = this._positionY;
        ...
        for (var index = 0; index < this.lensFlares.length; index++) {
            ...
            // Color
            this._effect.setFloat4("color", flare.color.r * intensity * this.color.r, flare.color.g * intensity * this.color.g, flare.color.b * intensity * this.color.b, 1.0 * this.color.a);
            // Draw order
